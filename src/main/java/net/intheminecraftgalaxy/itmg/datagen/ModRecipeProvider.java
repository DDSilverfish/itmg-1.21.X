        ...
        return new RecipeGenerator(registries, exporter) {
            ...
            public void generate() {
                ...
                ShapedRecipeJsonBuilder.create(itemLookup ,RecipeCategory.MISC, ModItems.HEART)
                        ...
                        .pattern("@#@")
                        .pattern(" @ ")
                        .input('@', ModBlocks.HEART_BLOCK.asItem())
                ...
                ShapedRecipeJsonBuilder.create(itemLookup,RecipeCategory.TOOLS, ModItems.VEIN_MINING_PICKAXE_ITEM)
                        .pattern(" # ")
                        .pattern("K@K")
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.COMBAT, ModItems.SNOW_SWORD)
                        .pattern(" S ")
                        .pattern(" S ")
                        .pattern("KT ")
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.COMBAT, ModItems.THUNDERBLADE)
                        .pattern("ABC")
                        .pattern("DEF")
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.TOOLS, ModItems.TIMBER_AXE_HEAD)
                        .pattern("SS")
                        .pattern("S ")
                ...
                ShapedRecipeJsonBuilder.create(itemLookup, RecipeCategory.TOOLS, ModItems.TIMBER_AXE)
                        .pattern("KTS")
